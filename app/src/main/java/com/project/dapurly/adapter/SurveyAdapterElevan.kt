...
import com.project.dapurly.databinding.RowSurveyLenguageBinding
import com.project.dapurly.model.SurveyRowModel

class SurveyAdapterElevan(var ctx: Context, val list: List<SurveyRowModel>) :
    RecyclerView.Adapter<SurveyAdapterElevan.RowSurveyVH>() {
    private var clickListener: OnItemClickListener? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RowSurveyVH {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.row_survey_lenguage, parent, false)
    ...
    inner class RowSurveyVH(
        ...
        val binding: RowSurveyLenguageBinding = RowSurveyLenguageBinding.bind(itemView)
    }
}
