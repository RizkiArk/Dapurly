...
import com.project.dapurly.databinding.ActivitySurveyOneBinding
...
class SurveyOneActivity : AppCompatActivity() {
    lateinit var binding: ActivitySurveyOneBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySurveyOneBinding.inflate(layoutInflater)
        ...
        recycleAdapter.setOnItemClickListener(object : SurveyAdapter.OnItemClickListener {
            ...
            override fun onItemClick(view: View, position: Int, item: SurveyRowModel) {
                item.isSelected = !item.isSelected // Toggle the selection

                if(checkStatus()){
                    binding.btnLanjut.background = resources.getDrawable(R.drawable.rectangle_bg_yellow_700_radius_8)
                }else {
                    binding.btnLanjut.background = resources.getDrawable(R.drawable.rectangle_bg_amber_200_radius_8)
                }
            }
        })
        ...
        binding.btnLanjut.setOnClickListener {
            for (data in dataList) {
                SurveyDataHolder.saveAnswer("bahan_yang_disukai", data.name ?: "", data.isSelected)
            }
            val intent = Intent(this@SurveyOneActivity, SurveyFiveActivity::class.java)
